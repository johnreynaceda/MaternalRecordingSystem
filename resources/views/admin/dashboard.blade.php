  ...
  <div class="flex-1 h-full">
    ...
    <div class="mt-16">
      <div class="bg-white rounded-xl relative p-8">
        ...
        <h1 class="text-md font-pop text-gray-400">Hello, <span
            class="text-green-600  uppercase">{{ auth()->user()->name }}</span>
        </h1>
    ...
    <div class="mt-10 relative">
      <div class="grid grid-cols-3 gap-4">
        <x-stats title="Active Patients" color="text-green-500" count="100" bgcolor="bg-green-500">
          <x-slot:icon>
        ...
        <x-stats title="Childs" color="text-main" count="100" bgcolor="bg-main">
          <x-slot:icon>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-8 w-8 fill-white">
              <path fill="none" d="M0 0h24v24H0z" />
              <path
        ...
        <x-stats title="Medicines" color="text-blue-500" count="100" bgcolor="bg-blue-500">
          <x-slot:icon>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-8 w-8 fill-white">
              <path fill="none" d="M0 0H24V24H0z" />
              <path
        ...
        <x-stats title="Users" color="text-gray-500" count="100" bgcolor="bg-gray-500">
          <x-slot:icon>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-8 w-8 fill-white">
              <path fill="none" d="M0 0h24v24H0z" />
